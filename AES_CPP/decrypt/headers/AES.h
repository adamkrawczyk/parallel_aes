...
protected:
  ...
  virtual void invSubBytes(state_type **state);
  virtual void invMixColumns(state_type **state);
  virtual void invShiftRows(state_type **state);
  ...
  virtual uint8_t xtime(uint8_t x);
...
public:
  ...
  virtual void elapsed_time(app_timer_t start, app_timer_t stop);
