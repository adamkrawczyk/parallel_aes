...
__constant__
inline uint8_t sbox[256] = { 0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5,
...
__constant__
inline uint8_t Rcon[11] = { 0x8d, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80,
		0x1b, 0x36 };

__constant__
inline uint8_t rsbox[256] = { 0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38,
...
__device__ void invCipher(state_type in[IN_LEN], state_type out[OUT_LEN], w_type w[KEY_ROUND]);
