...
int main() {
	...
	in_file.open("/home/silver/My-projects/CUDA/samples/0_Simple/project/AES_CUDA/decryptECB/data/in_str.txt", std::ios::binary);
    std::size_t file_size = std::experimental::filesystem::file_size("/home/silver/My-projects/CUDA/samples/0_Simple/project/AES_CUDA/decryptECB/data/in_str.txt");
	...
	decryptECB<<<1, 1>>>(encrypted_gpu, out_gpu, key_gpu);
    ...
    out_file.open("/home/silver/My-projects/CUDA/samples/0_Simple/project/AES_CUDA/decryptECB/data/out_str.txt", std::ios::binary);
